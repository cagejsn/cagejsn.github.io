    ...
    data: () => ({
        ...
        experiences: [
...

            {
                ...
                date: "2018-05",
                description: "I worked on a component of an brand new cloud architecture to help an online retailer move from on-prem to the cloud.",
                images: [],
            ...
            {
                title: 'Re-Platform Billing Jobs',
                type: 'Project',
                medium: "Software",
                personalOrProfessional: "Professional",
                organzation: "Slalom Consulting",
                date: "2020-04",
                description: "I worked on re-platforming several applications in a large digital advertising organization. Additionally, I worked on feature development to support advertising & billing in a new territory.",
                images: [],
...

            {
                ...
                organzation: "Slalom Consulting",
                date: "2022-10",
                description: "I took over an onboarding portal project, and delivered it to production. I integrated DataDog Real User Monitoring, and I wrote runbooks on the deployment methods.",
                images: [],
...

            {
                ...
                organzation: "Slalom Consulting",
                date: "2023-01",
                description: "I helped a large multi-national corporation build a set of highly configurable datapipelines that moved CRM data to a central datastore.",
                images: [],
...

            {
                ...
                organzation: "Slalom Consulting",
                date: "2023-07",
                description: "As part of a team responsible for Data Governance Tools, I built a data pipeline that identified duplicate datasets in different data stores. This helped reduce the total workload on stewards.",
                images: [],
...

            {
                ...
                date: "2023-11",
                description: "I am looking for my next role. I would like to work for a 30-500 person growth stage company. I am based in Austin and I will not consider moving.",
                images: [],                
